        ...
        <div class="bg-black/40 backdrop-blur-md border border-gray-700 rounded-lg p-8 shadow-2xl">
            <div class="text-center mb-8">
                ...
                <p class="mt-2 text-sm text-gray-300">
                    Or
                    <a href="{{ route('login') }}" class="font-medium text-white hover:text-gray-300 transition-colors">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input id="name" name="name" type="text" required 
                               class="appearance-none relative block w-full px-3 py-3 border {{ $errors->has('name') ? 'border-red-500' : 'border-gray-600' }} bg-black/20 backdrop-blur-sm placeholder-gray-400 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-white focus:border-white focus:z-10 sm:text-sm transition-all" 
                    ...
                    <div>
                        ...
                        <input id="password_confirmation" name="password_confirmation" type="password" autocomplete="new-password" required 
                               class="appearance-none relative block w-full px-3 py-3 border border-gray-600 bg-black/20 backdrop-blur-sm placeholder-gray-400 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-white focus:border-white focus:z-10 sm:text-sm transition-all" 
